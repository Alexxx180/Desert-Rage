# Desert-Rage
### Основы работы с репозиторием 'Desert-Rage', 
краткое руководство.
...
[Go to branch: master](https://github.com/Alexxx180/Tatarintsev_8901/tree/master)
...
/!\ Из-за такого лихого телепорта само время и символы у ветки
...
карта и пр. рекомендую перечитать мою документацию - оригинал 
прикреплен.
...
окна.
  Да так уж повелось что некоторые жанры игр намного 
...
размера и любой длительности. К сожалению их основной недостаток - колоссальная трата памяти, а результата, как говорится 0. Я убрал их из проекта, т.к. это экономически не выгодно.
